/*\
	Project 2020 - 2021 
	Aristotelis Gkouvas A.M.: 4009
	Mixalis Boukouvaslas A.M.: 3293
*/
...
int main(void)
{
	...
	GLuint programID = LoadShaders("StandardShade.vertexshader", "StandardShading.fragmentshader");
	...
	unsigned char* data = stbi_load("texture_sphere.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
